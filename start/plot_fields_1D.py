...
working_dir='/scratch/gpfs/MIKHAILOVA/zl8336/Small_a0/test/with_all_collision'
zoom_factor=1
...
Block_name_list=[
    ...
    {'name':'Current_Jx','label':'Jx/(ceNc)','normalize':C.speed_of_light*C.elementary_charge*laser_Nc},
    {'name':'Current_Jy','label':'Jy/(ceNc)','normalize':C.speed_of_light*C.elementary_charge*laser_Nc},
    {'name':'Current_Jz','label':'Jz/(ceNc)','normalize':C.speed_of_light*C.elementary_charge*laser_Nc},
