...
laser_spectrum_peak=C.pi**1.5*laser_amp*(laser_duration*C.speed_of_light)*(laser_w_0_lambda*laser_lambda)**2/2
laser_energy=(C.pi/2)**1.5*laser_amp**2*(laser_duration*C.speed_of_light)*(laser_w_0_lambda*laser_lambda)**2/2
