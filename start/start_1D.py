...
def set_blocks(laser_a0=10,target_Ne_Nc=300,D_lambda=3,L_lambda=0,theta_degree=0):
    ...
    control.t_end=1.1*vacuum_length_x_lambda*laser_period
    ...
    fields.ex="'%s'" %('/scratch/gpfs/MIKHAILOVA/zl8336/Curved_surface/no_curve/45/1D/Initialize_Field/Ex')
    fields.ey="'%s'" %('/scratch/gpfs/MIKHAILOVA/zl8336/Curved_surface/no_curve/45/1D/Initialize_Field/Ey')
    fields.ez="'%s'" %('/scratch/gpfs/MIKHAILOVA/zl8336/Curved_surface/no_curve/45/1D/Initialize_Field/Ez')
    fields.bx="'%s'" %('/scratch/gpfs/MIKHAILOVA/zl8336/Curved_surface/no_curve/45/1D/Initialize_Field/Bx')
    fields.by="'%s'" %('/scratch/gpfs/MIKHAILOVA/zl8336/Curved_surface/no_curve/45/1D/Initialize_Field/By')
    fields.bz="'%s'" %('/scratch/gpfs/MIKHAILOVA/zl8336/Curved_surface/no_curve/45/1D/Initialize_Field/Bz')
...
for i in np.linspace(0.55,1.95,num=29,endpoint=True):

    working_dir=os.path.join('/scratch/gpfs/MIKHAILOVA/zl8336/Curved_surface/no_curve/45/1D','ND_a0=%0.2f' %i)
    N=350
    a0=10
    D=i*a0/N
    block_list=set_blocks(laser_a0=a0,target_Ne_Nc=N,D_lambda=D,theta_degree=45)
