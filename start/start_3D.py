...
def set_blocks(laser_a0=10,target_ne_nc=300,target_thickness_lambda=0.005,theta_degree=0):
    ...
    laser.t_profile = 'gauss(time, %e-%e*y^2, %e+%e*y^2)' %(laser_delay,laser_period/(2*laser_radius_x_min_lambda*laser_lambda**2),laser_duration,laser_duration/(laser_radius_x_min_lambda*laser_lambda)**2/2)
    laser.t_start = 0.0
